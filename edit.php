			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<select name="Program_Studi" class="form-control" required>
						...
						<option value="Informatika" <?php if($data['Program_Studi'] == 'Informatika'){ echo 'selected'; } ?>>Informatika</option>
						<option value="Sistem Informasi" <?php if($data['Program_Studi'] == 'Sistem Informasi'){ echo 'selected'; } ?>>Sistem Informasi</option>
						<option value="Magister Teknik Industri" <?php if($data['Program_Studi'] == 'Magister Teknik Industri'){ echo 'selected'; } ?>>Magister Teknik Industri</option>
					</select>
				</div>
			</div>
			<div class="item form-group">
